...
{
    public class GenderPoc : Controller
    {
        private readonly WildcatMicroFundDatabaseContext _context;

        public GenderPoc(WildcatMicroFundDatabaseContext context)
        {
            _context = context;
        }
        ...
        // GET: GenderPoc/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: GenderPoc/Create
