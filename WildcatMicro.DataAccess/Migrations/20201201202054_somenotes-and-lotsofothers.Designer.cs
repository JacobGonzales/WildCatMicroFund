...
namespace WildcatMicro.DataAccess.Migrations
{
    ...
    [Migration("20201201202054_somenotes-and-lotsofothers")]
    partial class somenotesandlotsofothers
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WildcatMicro.Models.JudgeScores", b =>
                {
                    ...
                    b.HasKey("JudgeScoresId");

                    b.HasIndex("JudgeQuestionsId");
            ...
            modelBuilder.Entity("WildcatMicro.Models.JudgeScores", b =>
                {
                    b.HasOne("WildcatMicro.Models.JudgeQuestions", "JudgeQuestions")
                        .WithMany()
                        .HasForeignKey("JudgeQuestionsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WildcatMicro.Models.ScoreCard", "ScoreCard")
                        .WithMany()
